...
C   info@FastOpt.com
C
      subroutine adpres( u, ires, rpar, ipar, adpdelta, adpsenpar )
C***************************************************************
C***************************************************************
      ...
      if (ires .eq. 0) then
        do k = 1, m
          ...
          do j = 1, m
            ...
            adpdelta(i) = 0.d0
            adpsenpar(2) = adpsenpar(2)+adptemy*(u(i-m2)+u(i+m2)-2.d0*
     $u(i))
            adptemy = 0.d0
            adpsenpar(1) = adpsenpar(1)+adptemx*(u(i-1)+u(i+1)-2.d0*u(i)
     $)
            adptemx = 0.d0
          end do
        end do
