...
C
      ...
      EXTERNAL RESWEB, DJACILU, DPSOLILU, H_RESW
C
...
C Load values into IPAR and RPAR for sparse preconditioner.
      ...
      IPAR(16) = 50+3*maxny+nrpd ! start of Adifor work space in PSOL
      IPAR(30) = 0
      RPAR(1) = TOLILUT
      RPAR(2) = PERMTOL
...
C
     ...
     1        DJACILU, DPSOLILU, senpar, h_resw)
C
