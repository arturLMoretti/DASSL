      SUBROUTINE RESHILU(T,U,UPRIME,CJ,DELTA,IRES,RPAR,IPAR,senpar)
C
...
C
      ...
      DIMENSION U(2704), UPRIME(*), DELTA(1766), RPAR(*)
      DIMENSION IPAR(*),senpar(*)
C
...
C      
      RETURN
C------------  End of Subroutine RESHILU  ---------------------------------
      END
C------------  Subroutine RESHILU_OFP  ---------------------------------
      SUBROUTINE RESHILU_OFP(T,U,UPRIME,CJ,DELTA,IRES,RPAR,IPAR,senpar)
C
C This is the user-supplied RES subroutine for this example.
C It computes the residuals for the 2-D discretized heat equation,
C with zero boundary values.
C
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DIMENSION U(*), UPRIME(*), DELTA(1766), RPAR(*)
      DIMENSION IPAR(*),senpar(2)
C
C Set problem constants using IPAR and RPAR.
      NEQ = IPAR(33)
      M = IPAR(34)
...
C      
      RETURN
C------------  End of Subroutine RESHILU_OFP  ---------------------------------
      END
