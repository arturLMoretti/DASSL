...
C
      implicit none
      double precision t, y(*), ady(*), yp(*), cj, delta(*),
     *                 addelta(*), rp(*), senpar(*)
      integer ires, ip(*)
C
C     call TAMC generated routine
      call adyres(ires,  rp, ip, senpar, ady, addelta )
      
      return
      end
         
      SUBROUTINE RES_ADP(
     *             T, Y, YP, CJ, DELTA, ADDELTA, IRES, RP, 
     *             IP, SENPAR, ADSENPAR)
C
...
C
      implicit none
      double precision t, y(*), yp(*), cj, delta(*),
     *                 addelta(*), rp(*), senpar(*), adsenpar(*)
      integer ires, ip(*)
C
C     call TAMC generated routine
      call adpres(y, ires, rp, ip, addelta, adsenpar)
