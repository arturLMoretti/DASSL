...
C***REVISION DATE  981017   Sensitivity analysis for parameters
...
C
      ...
      EXTERNAL RESH, DJACILU, DPSOLILU, I_RES, H_RES, G_RES, 
     *     H_QRES, QRES
...
*      DIMENSION INFO(20), RPAR(4), IPAR(34)
      DIMENSION INFO(30), RPAR(4), IPAR(50+3*MXNEQ), 
     *          SENPAR(2), QSEN(100)
